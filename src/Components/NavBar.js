...
import menu_img_inv from "../images/menu-inverted.png";
  ...
  return (
    <div className={`nav ${isActive && "active"}`}>
      <div className="linkGroup">
        ...
        <a
          className={`links ${isActive && "nav-links"}`}
          style={{ paddingLeft: "60px" }}
          href="/"
        >
          Features
        </a>
        <a className={`links ${isActive && "nav-links"}`} href="/">
          Pricing
        </a>
        <a className={`links ${isActive && "nav-links"}`} href="/">
          Resources
      ...
      <div className="menu-img" onClick={handleClick}>
        <img src={isActive ? menu_img_inv : menu_img} alt="menu-icon" />
      </div>
      <div
        className="drop-down"
        style={{
          transform: !dropDown && "scaleY(0)",
        }}
      >
        ...
        <a className="links" style={{ paddingTop: "30px" }} href="/">
          Login
        </a>
